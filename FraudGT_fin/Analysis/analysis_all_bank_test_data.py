...
#  return data
  ...
  plt.savefig(f'all_banks_results_test/{save_to}.png')
  plt.show()
  ...
  df.to_csv(f'all_banks_results_test/{save_to}.csv')
 # print(df)
...
def patterns_transactions(data, patterns, save_to ):
  ...
  #  patterns_reduced = patterns#[['Timestamp', 'From Bank', 'Account', 'To Bank', 'Account.1', 'Laundering Type','Is Laundering']]
   ...
   # sns.heatmap(patterns,annot=True, ax=ax)
    ...
    patterns.to_csv(f'all_banks_results_test/{save_to}_patterns.csv')
    return 
