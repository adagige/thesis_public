...
def run():
    ...
    for run_id, seed, split_index in zip(*run_loop_settings()):
       ...
       # print('train loader', next(iter(loaders[0])))
     #
     #    print('loaders are here:',dataset.data_dict)
       # for batch in loaders[0]:
      #      print('batch split is\n\n',batch.split)
    ...
    torch.save(model.state_dict(), f'.results/model_AML_Medium_Li_RMP_{seed}.pth')
