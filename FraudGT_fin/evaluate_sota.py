...
def run():
    ...
    for run_id, seed, split_index in zip(*run_loop_settings()):
        ...
        # cfg.train.iter_per_epoch = 3000
        # cfg.val.iter_per_epoch = 3000
     #   cfg.test.iter_per_epoch = 7000
        ...
        print('pretrained dir:', cfg.pretrained.dir, flush=True)
        if cfg.pretrained.dir:
    ...
    #    eval_epoch(loggers[0], loaders[0], model, split='train', return_pred=True, only_test=False)
     ...
     #   eval_epoch(loggers[1], loaders[1], model, split='val', return_pred=True, only_test=False)
        ...
        eval_epoch(loggers[2], loaders[2], model, split='test', return_pred=True, only_test=True)
