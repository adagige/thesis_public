...
from fraudGT.graphgym.contrib.layer.generalconv import (GeneralConvLayer,
                                                GeneralEdgeConvLayer)
from fraudGT.graphgym.models.act import act_dict
...
class GeneralLayer(nn.Module):
    ...
    def __init__(self,
        ...
        print('\n \n layer dict is here ', layer_dict[name], 'key is:', name )
        layer_wrapper = []
        if has_bn:
